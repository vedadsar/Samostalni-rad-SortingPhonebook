	...
	public static void main(String[] args) {
		Person[] phonebook = new Person[] {
	      new Person("Aja", "Goehring"),
				...
				new Person("Lavette", "Džaferoviæ"),
				new Person("Mandi", "Èamæiæ"),
				new Person("Annett", "Sreèko"),
				new Person("Shantell", "Æampara"),
				new Person("Daphine", "Èampara"),
				new Person("Louella", "Hodzic"),
				new Person("Amalia", "Ðinðiæ"),
		...
		sortByComparator(phonebook, new CompareByLastName());
		printPhonebook(phonebook);
	}
